...
class CustomPropertyFiltersForm extends React.Component {
  ...
  render() {
    ...
    console.warn('Warning: <CustomPropertyFiltersForm> is deprecated in stripes-erm-components and will be removed in a future release');
    const {
      custPropName,
      customProperties,
      form: {
    ...
    return (
      <>
        <Button
          data-test-open-custprop-filters
                ...
                <React.Fragment key={name}>
                  ...
                  >
                    <Field
                      component={Select}
                      data-test-custprop
                      dataOptions={customProperties.map(t => ({ label: t.label, value: t.name }))}
