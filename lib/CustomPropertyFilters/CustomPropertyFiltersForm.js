...
class CustomPropertyFiltersForm extends React.Component {
  ...
  render() {
    ...
    let nameValue = custPropName;
    if (custPropName === 'supplementaryProperty') {
      nameValue = 'supplementary property';
    }
    const nameValueUpper = nameValue.substring(0, 1).toUpperCase() + nameValue.substring(1);
    ...
    return (
      <>
        ...
        >
          <FormattedMessage
            id="stripes-erm-components.customProperty.filters.editCustomPropertyFilters"
            values={{ custProp: nameValue }}
          />
        </Button>
        { editingFilters &&
          <Modal
            ...
            label={<FormattedMessage
              id="stripes-erm-components.customProperty.filters.builder"
              values={{ custProp: nameValueUpper }}
            />}
          ...
          >
              ...
              {({ fields }) => fields.map((name, index) => (
                <React.Fragment key={name}>
                  <EditCard
                    ...
                    deleteButtonTooltipText={<FormattedMessage id="stripes-erm-components.customProperty.filters.removeCustomProperty" values={{ index: index + 1, custProp: nameValue }} />}
                    header={<FormattedMessage id="stripes-erm-components.customProperty.filters.customPropertyFilterIndex" values={{ index: index + 1, custProp: nameValueUpper }} />}
            ...
            >
              <FormattedMessage id="stripes-erm-components.customProperty.filters.addCustomPropertyFilter" values={{ custProp: nameValue }} />
            </Button>
          </Modal>
        }
      </>
