...
const DocumentFilter = ({ activeFilters, refdataValues = [], filterHandlers }) => {
  // refdataValues are only passed for SupplementaryDocumentFilter
  const filterType = refdataValues.length > 0 ? 'supplementaryDocuments' : 'documents';
