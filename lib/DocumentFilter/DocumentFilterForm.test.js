...
describe('DocumentFilterForm', () => {
  ...
  describe.each([
    ...
    describe('opening the filter form', () => {
      ...
      it('should open the document filter builder modal when the edit button is clicked', () => {
        const { getByText } = renderComponent;
        fireEvent.click(getByText('Edit document filters'));
      ...
      describe('making form dirty for submittal', () => {
        ...
        it('should close the filter form when cancel button is clicked', async () => {
          const { queryByText } = renderComponent;
          await waitFor(async () => {
            await Button('Edit document filters').click();
          });
