...
export default class SerialCoverage extends React.Component {
  ...
  renderIssue = (issue) => {
    ...
    return (
      <div data-testid="issueDisplay">
        <FormattedMessage id="ui-agreements.coverage.issueShort" values={{ value: issue }} />
      </div>
    );
  }
  ...
  render() {
    ...
    return (
      <Layout className="full" data-test-serial-coverage data-testid="serialCoverage">
