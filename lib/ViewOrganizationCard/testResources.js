const emptyFieldProps = {
  ...
  'duplicateMessage': '<Memo />',
  'duplicateWarning': false,
  'headerEnd': 'Link organization',
  'headerStart': 'Organization',
  'id': 'orgs-0',
  'setDuplicateWarning': 'ƒ bound dispatchAction() {}',
  'fetchCredentials': 'ƒ fetchCredentials() {}'
};
...
const initialValues = {
  ...
  'handlers': {
    'onBasketLinesAdded': 'ƒ handleBasketLinesAdded() {}',
    'onClose': 'ƒ handleClose() {}'
  },
  'initialValues': {
...
const interfacesProps = {
  ...
  'note': 'test',
  'interfaces': [
    'fae74b9c-5338-4cd6-8a17-47c750d40b7b',
    'cd592659-77aa-4eb3-ac34-c9a4657bb20f'
  ],
};
