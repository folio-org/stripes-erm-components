...
import { Button, Card, Col, KeyValue, NoValue, Row } from '@folio/stripes/components';
...
export default class CustomPropertyFieldView extends React.Component {
  ...
  render() {
    ...
    console.warn('Warning: <CustomPropertyFieldView> is deprecated in stripes-erm-components and will be removed in a future release');
