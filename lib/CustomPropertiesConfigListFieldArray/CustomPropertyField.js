...
class CustomPropertyField extends React.Component {
  ...
  render() {
    ...
    console.warn('Warning: <CustomPropertyField> is deprecated in stripes-erm-components and will be removed in a future release');
    ...
    return (
      <>
        <div data-testid="customePropertyField">
          ...
          <ConfirmationModal
            ...
            message={<SafeHTMLMessage id="stripes-erm-components.customProperties.delete.confirmMessage" values={{ custProp: formatMessage(messages.customProperty), name: custPropName }} />}
