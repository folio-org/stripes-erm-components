            ...
            <Pluggable
              ...
              renderTrigger={(props) => {
                ...
                if (this.props.organization) {
                  if (this.props.organization.org) {
                    orgName = this.props.organization.org.name
                  }
                }
                ...
                return (
                  isOrgSelected ?
                  <Tooltip
                    text={<FormattedMessage id="stripes-erm-components.organizations.replaceOrganizationSpecific" values={{ orgName: orgName }} />}
