...
export default function withKiwtFieldArray(WrappedComponent) {
  class WithKiwtFieldArray extends React.Component {
    ...
    constructor(props) {
      ...
      if (props.fields.getAll) {
        console.warn( // eslint-disable-line no-console
          'withKiwtFieldArray: Usage of this component with redux-form is deprecated and will be removed in version 3.0.0.' +
          'Switch to react-final-form if you want to keep using this component.'
        );
      }
    ...
    render() {
      ...
      console.warn(`Warning: <withKiwtFieldArray> is deprecated in stripes-erm-components and will be removed in a future release
       Switch to importing useKiwtFieldArray from @k-int/stripes-kint-components instead
       `);
      const { fields } = this.props;
