...
| onDeleteField | function (index, objectToBeDeleted) => {} | Should be called when deleting an object from the array. **Both the `index` and `objectToBeDeleted` parameters are required.** |
