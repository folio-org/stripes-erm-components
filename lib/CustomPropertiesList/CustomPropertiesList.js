...
import { Card, Col, InfoPopover, KeyValue, Layout, NoValue, Row } from '@folio/stripes/components';
...
export default class CustomPropertiesList extends React.Component {
      ...
      >
        <Row>
          <Col xs={6}>
            ...
            >
              <span
                data-test-customproperty-value={customProperty.name}
  ...
  render() {
    ...
    console.warn('Warning: <CustomPropertiesList> is deprecated in stripes-erm-components and will be removed in a future release');
