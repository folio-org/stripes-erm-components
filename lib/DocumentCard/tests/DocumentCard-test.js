...
describe('DocumentCard', () => {
  describe('rendering', () => {
    ...
    it('Sets Headline to docs name', () => {
      expect(documentcard.renderHeadline).to.equal('A test document attachment');
    });
    ...
    it('Sets Note to docs note', () => {
      expect(documentcard.renderNote).to.equal('This is a test document attachment');
    });
    ...
    it('Sets Headline to docs URL', () => {
      expect(documentcard.renderURL).to.equal('http://a.b.c/e');
    });
    ...
    it('Sets location to docs name', () => {
      expect(documentcard.renderLocation).to.equal('http://a.b.c/d/e/g.doc');
    });
  });
});
