...
jest.mock('../../hooks/useRestrictionPolicies/useReadPolicies/useReadPolicies');
jest.mock('../../hooks/useDoAccessControl/useDoAccessControl');
  ...
  describe.each([
    ...
    beforeEach(() => {
      ...
      if (readPoliciesMockImplementation) {
        useReadPolicies.mockImplementationOnce(readPoliciesMockImplementation);
      }
      useDoAccessControl.mockClear();
      if (doAccessControlMockImplementation) {
        useDoAccessControl.mockImplementationOnce(doAccessControlMockImplementation);
      }
