...
jest.mock('../../hooks', () => {
  ...
  const useClaimPolicies = jest.fn(() => ({
    flattenedPolicies: policiesFlattener(mockClaimPolicies.claimPolicies),
    policies: mockClaimPolicies
  }));

  const mockUseDoAccessControl = jest.fn(() => ({
  ...
  return ({
    ...actualHooks,
    useClaimPolicies,
    useDoAccessControl: mockUseDoAccessControl
  });
});
