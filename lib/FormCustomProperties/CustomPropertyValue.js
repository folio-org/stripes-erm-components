...
class CustomPropertyValue extends React.Component {
  ...
  render() {
    ...
    console.warn('Warning: <CustomPropertyValue> is deprecated in stripes-erm-components and will be removed in a future release');
    ...
    const handleChange = e => {
      onChange({
        ...
        [customProperty.value]: [{
          ...
          value: (customProperty.type === customPropertyTypes.NUMBER ||
