...
const onSubmit = spy(values => {
  debugger;
  console.log(values);
});

describe.only('FormCustomProperties', () => {
  ...
  describe('Mount without initial value', () => {
    ...
    beforeEach(async function () {
      ...
      decimalTypeTerm = this.server.create('term', {
        'label': 'decimal',
        'name': 'decimal term',
        'primary': false,
      ...
      terms = [refDataTypeTerm, decimalTypeTerm, integerTypeTerm, textTypeTerm];
    ...
    describe('handling add', () => {
      ...
      describe('selecting decimal', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
        });
    ...
    describe('validation rules', () => {
      ...
      describe('Selecting an integer type and entering a number not in range', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('9007199254740992');
        });
      ...
      describe('Selecting an integer type and entering a non-integer number', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('10.34');
        });
      ...
      describe('Selecting an integer type and entering a negative integer', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('-10');
        });

        it('should not throw a validation error', () => {
          expect(formCustomPropertiesInteractor.customPropertyInteractor(0).hasError).to.be.false;
        });
      });

      describe('Selecting an integer type and entering an invalid number', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('10.-');
        });
      ...
      describe('Selecting a decimal type and entering a number not in range', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('9007199254740992');
        });
      ...
      describe('Selecting a decimal type and entering an integer', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('-13');
        });
      ...
      describe('Selecting a decimal type and entering a number with more than 2 decimals', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('13.43267');
        });
      ...
      describe('Selecting a decimal type and entering a number with 2 decimals', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('13.43');
        });
      ...
      describe('Selecting a decimal type and entering a negative number', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('-13.43');
        });
      ...
      describe('Selecting a decimal type and entering an invalid input', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('10.-');
        });
      ...
      describe('entering a note without a value', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue();
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurNote('a');
        });
      ...
      describe('entering a public note without a value', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue();
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurPublicNote('a');
        });
      ...
      describe('toggling visibility without a value', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue();
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurVisibility('internal');
        });
    ...
    describe.only('submitting the values', () => {
      beforeEach(async () => {
        await formCustomPropertiesInteractor.clickAddButton();
        await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('text');
        await formCustomPropertiesInteractor.customPropertyInteractor(0).fillNote('this is an internal note');
        await formCustomPropertiesInteractor.customPropertyInteractor(0).fillPublicNote('this is a public note');
        await formCustomPropertiesInteractor.customPropertyInteractor(0).fillValue('lorem ipsum');
