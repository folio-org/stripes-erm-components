...
describe('FormCustomProperties', () => {
  ...
  describe('Mount without initial value', () => {
    ...
    describe('validation rules', () => {
      ...
      describe.skip('Selecting an integer type and entering a number not in range', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
      ...
      describe.skip('Selecting an integer type and entering a non-integer number', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
      ...
      describe.skip('Selecting an integer type and entering an invalid number', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('10.-');
        });
      ...
      describe.skip('Selecting a decimal type and entering a number not in range', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('9007199254740992');
        });
      ...
      describe.skip('Selecting a decimal type and entering an integer', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
      ...
      describe.skip('Selecting a decimal type and entering a number with more than 2 decimals', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
      ...
      describe.skip('Selecting a decimal type and entering an invalid input', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('decimal');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue('10.-');
        });
      ...
      describe.skip('entering a note without a value', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
      ...
      describe.skip('entering a public note without a value', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue();
      ...
      describe.skip('toggling visibility without a value', () => {
        beforeEach(async () => {
          await formCustomPropertiesInteractor.customPropertyInteractor(0).nameField.selectOption('integer');
          await formCustomPropertiesInteractor.customPropertyInteractor(0).fillAndBlurValue();
