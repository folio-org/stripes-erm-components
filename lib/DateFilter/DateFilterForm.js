...
const DateFilterForm = ({ handleSubmit, name, resourceName, showNoDateCheckbox }) => {
    ...
    <>
      ...
      {showNoDateCheckbox &&
        <Layout className="padding-bottom-gutter">
          <Field
            component={Checkbox}
            label={<FormattedMessage id={`stripes-erm-components.dateFilter.${name}NotSet`} values={{ resourceName }} />}
            name="isDateSet"
            type="checkbox"
          />
        </Layout>
...
DateFilterForm.propTypes = {
  ...
  showNoDateCheckbox: PropTypes.bool
};
