...
const DateFilter = ({ activeFilters, filterHandlers, hideNoDateSetCheckbox, intlModuleName, name, resourceName }) => {
  ...
  return (
    <Accordion
      ...
      label={<FormattedMessage id={`${intlModuleName ?? 'stripes-erm-components'}.dateFilter.${name}`} />}
...
DateFilter.propTypes = {
  ...
  intlModuleName: PropTypes.string,
