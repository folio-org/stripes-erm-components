...
const DateFilter = ({
  ...
  const renderAccordionLabel = accordionLabel ?? <FormattedMessage id={`stripes-erm-components.dateFilter.${name}`} />;
  const renderNoDateSetCheckboxLabel =
  ...
  return (
    ...
    >
      <DateFilterForm
        ...
        renderNoDateSetCheckboxLabel={renderNoDateSetCheckboxLabel}
      />
    </Accordion>
  );
};
...
DateFilter.propTypes = {
  ...
  noDateSetCheckboxLabel: PropTypes.string,
