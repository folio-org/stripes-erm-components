      ...
      renderTrigger={(props) => {
        ...
        if (value) {
          return (
            ...
            >
              {({ ref, ariaIds }) => (
                <Button aria-labelledby={ariaIds.text} buttonRef={ref} data-test-ic-link-user marginBottom0 {...buttonProps} >
        ...
        return (
          <Button buttonRef={this.triggerButton} data-test-ic-link-user marginBottom0 {...buttonProps} >
