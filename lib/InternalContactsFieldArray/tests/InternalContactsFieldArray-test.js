...
describe('InternalContactsFieldArray', () => {
  ...
  describe('rendering default user values', () => {
    ...
    it('renders a placeholder last name', () => {
      expect(interactor.contacts(2).userLastName).to.equal('-');
    });

    it('renders a placeholder first name', () => {
      expect(interactor.contacts(2).userFirstName).to.equal('-');
    });
